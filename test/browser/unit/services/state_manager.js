...
describe('State manager unit tests', function() {
  ...
  */
  ...
  it('After calling init_page_load() initial state should be false.',
    function() {
      sm.initPageLoad();
  ...
  it('After calling add_view, current views should have a length of 1.',
    function() {
      sm.addView(testView);
      expect(sm.currentViews).to.have.length(1);
    });

  it('After calling remove_view, current views should have a length of 0.',
    function() {
      sm.removeView(testView);
      expect(sm.currentViews).to.have.length(0);
    });

  it('current views should have a length of 0 and each eview should be off.',
    function() {
      sm.addView(testView);
  ...
  it('current views should have a length of 1 and each view should be on.',
    function() {
      sm.addView(testView);
